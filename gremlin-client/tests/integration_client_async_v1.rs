...
mod aio {
    ...
    async fn test_client_connection_ok_v1() {
        connect_serializer(GraphSON::V1).await;
    }

    // count not supported in the stream extension of tokio

    #[cfg(feature = "async-std-runtime")]
    #[cfg_attr(feature = "async-std-runtime", async_std::test)]
    async fn test_empty_query_v1() {
    ...
    #[cfg_attr(feature = "async-std-runtime", async_std::test)]
    #[cfg_attr(feature = "tokio-runtime", tokio::test)]
    async fn test_vertex_creation_v1() {
        let graph = connect_serializer(GraphSON::V1).await;
    ...
    #[cfg_attr(feature = "async-std-runtime", async_std::test)]
    #[cfg_attr(feature = "tokio-runtime", tokio::test)]
    async fn test_edge_creation_v1() {
        let graph = connect_serializer(GraphSON::V1).await;
        let mark = create_vertex(&graph, "mark").await;
